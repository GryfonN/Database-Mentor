...
function mcImgSlider(k) {
    ...
    E.prototype = {k: {c: k.transitionTime, a: function () {
    }, b: E.a.f, d: 1}, m: function (h, d, g, c) {
    ...
    var l = new E, ob = function () {
        ...
        a = {b: k.pauseTime, c: k.transitionTime, f: k.slices, g: k.boxes, d: k.license, h: k.hoverPause, i: k.autoAdvance, j: k.captionOpacity, k: k.captionEffect == "none" ? 0 : k.captionEffect == "fade" ? 1 : 2, l: k.thumbnailsWrapperId, Ob: function () {
    ...
    ub.prototype = {c: function () {
        ...
        var g = {b: E.a.j, c: a.c * 1.6, a: function () {
            m.o()
        }};
